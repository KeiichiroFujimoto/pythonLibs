...
class AngularRate(EngUnit):
    """Creates a angular rate object that can store a angular rate value and 
    convert between units of angular rate."""
...
if __name__ == '__main__':
    ...
    angVel1 = AngularRate(1.0, AngularRate.Unit.deg_s)
    angVel1.changeUnit('rpm')
    print(angVel1.value)
    print(angVel1.unit)
